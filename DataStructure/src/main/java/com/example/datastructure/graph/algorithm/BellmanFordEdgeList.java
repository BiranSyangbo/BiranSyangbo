...
public class BellmanFordEdgeList {
    ...
    public static void main(String[] args) {
        ...
        int E = 13, V = 10, start = 0;
        Edge[] edges = new Edge[E];

        edges[0] = new Edge(0, 1, 5);
        edges[1] = new Edge(1, 6, 60);
        edges[2] = new Edge(1, 2, 20);
        edges[3] = new Edge(1, 5, 30);
        edges[4] = new Edge(2, 3, 10);
        edges[5] = new Edge(2, 4, 75);
        edges[6] = new Edge(3, 2, -15);
        edges[7] = new Edge(4, 9, 100);
        edges[8] = new Edge(5, 4, 25);
        edges[9] = new Edge(5, 6, 5);
        edges[10] = new Edge(5, 8, 50);
